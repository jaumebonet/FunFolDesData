...
# Common
COMMON="-abinitio:relax -relax:fast -abinitio:increase_cycles 10 -abinitio:rg_reweight 0.5 -abinitio:rsd_wt_helix 0.5 -abinitio:rsd_wt_loop 0.5 -in:fix_disulf disulfides.cyd -abinitio:detect_disulfide_before_relax true"
